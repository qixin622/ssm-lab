...
$(function () {
  ...
  var PICKERHEADERTPL = '<div class="{{className}}__header">' +
    ...
    '{{next}}' +
    '</div>';
  PICKERHEADERPREVTPL = '<i class="icon-angle-double-left c-datepicker-picker__icon-btn {{className}}__prev-btn year" aria-label="前一年"></i>' +
    '<i class="icon-angle-left c-datepicker-picker__icon-btn {{className}}__prev-btn month" aria-label="上个月"></i>';
  PICKERHEADERNEXTTPL = '<i class="icon-angle-right c-datepicker-picker__icon-btn {{className}}__next-btn month" aria-label="下个月"></i>' +
    '<i class="icon-angle-double-right c-datepicker-picker__icon-btn {{className}}__next-btn year" aria-label="后一年"></i>';
  PICKERHEADERNEXTSINGLETPL = '<i class="icon-angle-double-right c-datepicker-picker__icon-btn {{className}}__next-btn year" aria-label="后一年"></i>' +
    '<i class="icon-angle-right c-datepicker-picker__icon-btn {{className}}__next-btn month" aria-label="下个月"></i>';
  ...
  var RANGEPICKERMAINTPL = '<div class="c-datepicker-picker c-datepicker-date-range-picker c-datepicker-popper {{hasTime}} {{hasSidebar}}" x-placement="top-start">' +
    ...
    PICKERARROWTPL +
    '</div>';
  var PICKERFOOTERNOWBUTTON = PICKERFOOTERTPL.replace(/{{className}}/g, 'c-datepicker-picker__btn-now').replace(/{{text}}/g, '今天');
