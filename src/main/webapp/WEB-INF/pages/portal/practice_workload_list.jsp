        ...
        <div class="padding-large-left padding-large-right">
            <div class="panel margin-big-bottom">
                <div class="panel-head">
                    <h1 class="text-main text-center icon-calendar"> 实践工作量列表</h1>
                </div>
                <div class="panel-body">
                    <div class="line text-center margin-bottom">
                        <form:form action="${ctx}/practice/workload/list" modelAttribute="workloadForm" cssClass="form-x form-inline">
                            ...
                            <button type="button" class="button border-green"
                                    onclick="javascript:window.location.href='${ctx}/practice/workload/list';"><span
