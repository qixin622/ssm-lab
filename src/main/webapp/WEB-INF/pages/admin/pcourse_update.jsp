...
<div class="admin">
    <div class="line padding-big">
        <div class="panel admin-panel">
            <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>修改实践课程</strong></div>
            <div class="body-content margin-big-left margin-big-right">
                <form:form method="post" action="${ctx}/manage/pcourse/update" modelAttribute="course" id="updateForm" name="updateForm" enctype="multipart/form-data" onsubmit="return checksubmit()">
                    <form:hidden path="id"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="field">
                            <form:input class="input" path="property" placeholder="课程性质" data-validate="required:请输入实践课程性质"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="label">
                        ...
                        <div class="field">
                            <form:input path="level" class="input" placeholder="适合层次..." data-validate="required:请输入适合层次"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="label">
