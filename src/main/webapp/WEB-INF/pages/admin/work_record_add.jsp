...
<div class="admin">
    <div class="line padding-big">
        <div class="panel admin-panel">
            <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>添加工作内容信息</strong></div>
            <div class="body-content margin-big-left margin-big-right">
                <form:form method="post" action="${ctx}/manage/workrecord/add" modelAttribute="record" id="addForm" name="addForm">
                    <div class="form-group">
                        ...
                        <div class="field">
                            <div class="c-datepicker-date-editor c-datepicker-single-editor J-datepickerTime-single mt10">
                                ...
                                <input type="text" autocomplete="off" name="createTime" id="createTime" placeholder="选择记录时间..." class=" c-datepicker-data-input" data-validate="required:请选择记录时间"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
