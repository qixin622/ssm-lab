...
<div class="admin">
    <div class="line padding-big">
        <div class="panel admin-panel">
            <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>添加员工</strong></div>
            <div class="body-content margin-big-left margin-big-right">
                <form:form method="post" action="${ctx}/manage/user/add" modelAttribute="user" id="addForm" name="addForm"
                    ...
                    <div class="form-group">
                        ...
                        <div class="field">
                            <form:input path="sn" class="input" placeholder="请输入教工编号..."
                                        data-validate="required:请输入教工编号,plusinteger:请输入数字,length#==8:教工编号长度为8,ajax#${ctx}/manage/user/checkSn?sn=:教工编号已存在"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="label">
                        ...
                        <div class="field">
                            <div class="button-group radio">
                                <label class="button active">
                                    <form:radiobutton path="sex" value="男" checked="checked"/><span
                                        class="icon icon-male"></span> 男
                                </label>
                                <label class="button">
                                    <form:radiobutton path="sex" value="女"/><span class="icon icon-female"></span> 女
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="field">
                            <div class="c-datepicker-date-editor c-datepicker-single-editor J-datepicker-day mt10">
                                ...
                                <input type="text" autocomplete="off" name="birthday" id="birthday" placeholder="选择出生日期..." class=" c-datepicker-data-input only-date" readonly="readonly">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
