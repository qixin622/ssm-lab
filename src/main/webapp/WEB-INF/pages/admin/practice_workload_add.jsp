...
<div class="admin">
    <div class="line padding-big">
        <form:form method="post" action="${ctx}/manage/practice/workload/add" modelAttribute="info" id="addForm"
                   name="addForm">
            <div class="panel admin-panel">
                <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span> 添加实践工作量</strong>
                </div>
                    ...
                    <div class="line">
                        <div class="xs6 xm8 xb8">
                            <div class="form-group">
                                ...
                                <div class="field">
                                    <select id="workload.cid" name="workload.cid" class="input" data-validate="required:请选择实验课程">
                    ...
                    <div class="line">
                        ...
                        <div class="xs6 xm2 xb2">
                            <div class="form-group margin-left">
                                ...
                                <div class="field">
                                    <form:input cssClass="input rate" path="workload.preWorkloadRate" value="0"/>
                                </div>
                            </div>
                        </div>
                        <div class="xs6 xm2 xb2">
                            <div class="form-group margin-left">
                                ...
                                <div class="field">
                                    <form:input cssClass="input workload" path="workload.preWorkload" value="0"/>
                                </div>
                            </div>
                        </div>
                    </div>
