...
<div class="admin">
    <div class="line padding-big">
        <div class="panel admin-panel">
            <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>修改实验室信息内容</strong></div>
            <div class="body-content margin-big-left margin-big-right">
                <form:form method="post" action="${ctx}/manage/labinfo/update" modelAttribute="labInfo" id="updateForm" name="updateForm">
                    <form:hidden path="id"/>
