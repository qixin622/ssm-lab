...
<div class="admin">
    <div class="line padding-big">
        <div class="panel admin-panel">
            <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>编辑实验项目</strong></div>
            <div class="body-content margin-big-left margin-big-right">
                <form:form method="post" action="${ctx}/manage/courseitem/update" modelAttribute="courseitem" id="updateForm" name="updateForm" >
                    <form:hidden path="id"/>
                    <form:hidden path="cid"/>
                    <div class="margin-big-bottom">所属课程：${courseitem.course.cname}</div>
