    ...
    <div class="line padding-big">
        <div class="panel admin-panel">
            ...
            <div class="body-content margin-big-left margin-big-right">
                <form:form method="post" action="${ctx}/manage/article/update" modelAttribute="article" id="updateForm" name="updateForm" enctype="multipart/form-data" onsubmit="return checksubmit();">
                    <form:hidden path="id"/>
