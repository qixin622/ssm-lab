...
<div class="admin">
    <div class="line padding-big">
        <div class="panel admin-panel">
            <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>添加借出信息</strong></div>
            <div class="body-content margin-big-left margin-big-right">
                <form:form method="post" action="${ctx}/manage/borrow/add" modelAttribute="borrow" id="addForm" name="addForm">
                    ...
                    <div class="line">
                        ...
                        <div class="xs6 xm3 xb3">
                            <div class="form-group margin-left">
                                ...
                                <div class="field">
                                    <input id="borrowSn" name="borrowSn" class="input" list="teachers">
                    ...
                    <div class="form-group">
                        ...
                        <div class="field">
                            <div class="button-group radio">
                                <form:textarea path="remarks" style="width:700px;height:150px;" placeholder="备注信息..."></form:textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
